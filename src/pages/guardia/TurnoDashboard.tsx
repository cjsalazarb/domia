    ...
    <div style={{ minHeight: '100vh', backgroundColor: '#F4F7F5', fontFamily: "'Inter', sans-serif" }}>
      <div style={{
        ...
        <div>
          ...
          <span style={{ marginLeft: '12px', fontSize: '13px', opacity: 0.8 }}>Panel Guardia</span>
        </div>
      ...
      <div style={{ padding: '24px', maxWidth: '800px', margin: '0 auto' }}>
        ...
        <p style={{ color: '#5E6B62', fontSize: '14px', marginBottom: '24px' }}>
          {profile?.nombre} {profile?.apellido} — Guardia de seguridad
        </p>
        ...
        <div style={{
          ...
          Módulo en construcción — próximamente libro de novedades e incidentes
        </div>
      </div>
    </div>
  )
