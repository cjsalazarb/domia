...
INSERT INTO recibos (id, condominio_id, unidad_id, residente_id, periodo, monto_base, estado, fecha_vencimiento) VALUES
  ('cccccccc-0000-0000-0201-000000000001', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000101', 'bbbbbbbb-0000-0000-0000-000000000001', '2026-02-01', 500, 'pagado', '2026-02-15'),
  ('cccccccc-0000-0000-0201-000000000002', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000102', 'bbbbbbbb-0000-0000-0000-000000000002', '2026-02-01', 500, 'pagado', '2026-02-15'),
  ('cccccccc-0000-0000-0201-000000000003', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000103', 'bbbbbbbb-0000-0000-0000-000000000003', '2026-02-01', 500, 'pagado', '2026-02-15'),
  ('cccccccc-0000-0000-0201-000000000004', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000201', 'bbbbbbbb-0000-0000-0000-000000000004', '2026-02-01', 500, 'vencido', '2026-02-15'),
  ('cccccccc-0000-0000-0201-000000000005', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000202', 'bbbbbbbb-0000-0000-0000-000000000005', '2026-02-01', 500, 'pagado', '2026-02-15'),
  ('cccccccc-0000-0000-0201-000000000006', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000203', 'bbbbbbbb-0000-0000-0000-000000000006', '2026-02-01', 500, 'pagado', '2026-02-15'),
  ('cccccccc-0000-0000-0201-000000000007', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000301', 'bbbbbbbb-0000-0000-0000-000000000007', '2026-02-01', 500, 'pagado', '2026-02-15'),
  ('cccccccc-0000-0000-0201-000000000008', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000302', 'bbbbbbbb-0000-0000-0000-000000000008', '2026-02-01', 500, 'pagado', '2026-02-15');

-- ━━━ RECIBOS MARZO 2026 ━━━
INSERT INTO recibos (id, condominio_id, unidad_id, residente_id, periodo, monto_base, estado, fecha_vencimiento) VALUES
  ('cccccccc-0000-0000-0301-000000000001', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000101', 'bbbbbbbb-0000-0000-0000-000000000001', '2026-03-01', 500, 'pagado', '2026-03-15'),
  ('cccccccc-0000-0000-0301-000000000002', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000102', 'bbbbbbbb-0000-0000-0000-000000000002', '2026-03-01', 500, 'pagado', '2026-03-15'),
  ('cccccccc-0000-0000-0301-000000000003', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000103', 'bbbbbbbb-0000-0000-0000-000000000003', '2026-03-01', 500, 'pagado', '2026-03-15'),
  ('cccccccc-0000-0000-0301-000000000004', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000201', 'bbbbbbbb-0000-0000-0000-000000000004', '2026-03-01', 500, 'vencido', '2026-03-15'),
  ('cccccccc-0000-0000-0301-000000000005', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000202', 'bbbbbbbb-0000-0000-0000-000000000005', '2026-03-01', 500, 'vencido', '2026-03-15'),
  ('cccccccc-0000-0000-0301-000000000006', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000203', 'bbbbbbbb-0000-0000-0000-000000000006', '2026-03-01', 500, 'pagado', '2026-03-15'),
  ('cccccccc-0000-0000-0301-000000000007', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000301', 'bbbbbbbb-0000-0000-0000-000000000007', '2026-03-01', 500, 'pagado', '2026-03-15'),
  ('cccccccc-0000-0000-0301-000000000008', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000302', 'bbbbbbbb-0000-0000-0000-000000000008', '2026-03-01', 500, 'pagado', '2026-03-15');

-- ━━━ RECIBOS ABRIL 2026 (mes actual) ━━━
INSERT INTO recibos (id, condominio_id, unidad_id, residente_id, periodo, monto_base, estado, fecha_vencimiento) VALUES
  ('cccccccc-0000-0000-0401-000000000001', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000101', 'bbbbbbbb-0000-0000-0000-000000000001', '2026-04-01', 500, 'pagado', '2026-04-15'),
  ('cccccccc-0000-0000-0401-000000000002', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000102', 'bbbbbbbb-0000-0000-0000-000000000002', '2026-04-01', 500, 'pagado', '2026-04-15'),
  ('cccccccc-0000-0000-0401-000000000003', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000103', 'bbbbbbbb-0000-0000-0000-000000000003', '2026-04-01', 500, 'pagado', '2026-04-15'),
  ('cccccccc-0000-0000-0401-000000000004', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000201', 'bbbbbbbb-0000-0000-0000-000000000004', '2026-04-01', 500, 'vencido', '2026-04-15'),
  ('cccccccc-0000-0000-0401-000000000005', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000202', 'bbbbbbbb-0000-0000-0000-000000000005', '2026-04-01', 500, 'vencido', '2026-04-15'),
  ('cccccccc-0000-0000-0401-000000000006', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000203', 'bbbbbbbb-0000-0000-0000-000000000006', '2026-04-01', 500, 'vencido', '2026-04-15'),
  ('cccccccc-0000-0000-0401-000000000007', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000301', 'bbbbbbbb-0000-0000-0000-000000000007', '2026-04-01', 500, 'emitido', '2026-04-30'),
  ('cccccccc-0000-0000-0401-000000000008', 'aaaaaaaa-0000-0000-0000-000000000001', 'aaaaaaaa-0000-0000-0000-000000000302', 'bbbbbbbb-0000-0000-0000-000000000008', '2026-04-01', 500, 'emitido', '2026-04-30');
